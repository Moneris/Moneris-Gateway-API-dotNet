namespace Moneris
{
	...
	public class TestAxRaIndependentRefund
	{
		public static void Main(string[] args)
		{
			...
			AxRaIndependentRefund axRaIndependentRefund = new AxRaIndependentRefund();
			axRaIndependentRefund.SetOrderId(order_id);
			axRaIndependentRefund.SetCustId(cust_id);
			axRaIndependentRefund.SetAmount(amount);
			axRaIndependentRefund.SetPan(pan);
			axRaIndependentRefund.SetExpDate(expiry_date);
			axRaIndependentRefund.SetCryptType(crypt);
			axRaIndependentRefund.SetAxRaLevel23(raLevel23);
            ...
            mpgReq.SetTransaction(axRaIndependentRefund);
