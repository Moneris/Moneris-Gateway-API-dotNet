namespace Moneris
{
	...
	public class TestAxRaForcePost
	{
		public static void Main(string[] args)
		{
			...
			AxRaForcePost axRaForcePost = new AxRaForcePost();
			axRaForcePost.SetOrderId(order_id);
			axRaForcePost.SetCustId(cust_id);
			axRaForcePost.SetAmount(amount);
			axRaForcePost.SetPan(pan);
			axRaForcePost.SetExpDate(expiry_date);
			axRaForcePost.SetAuthCode(auth_code);
			axRaForcePost.SetCryptType(crypt);
			axRaForcePost.SetAxRaLevel23(raLevel23);
            ...
            mpgReq.SetTransaction(axRaForcePost);
