namespace Moneris
{
    ...
    public class TestCanadaMCPCavvPreauth
    {
        public static void Main(string[] args)
        {
			...
			//mcpCavvPreauth.SetDsTransId("12345"); //Optional - to be used only if you are using 3rd party 3ds 2.0 service
            //mcpCavvPreauth.SetWalletIndicator(wallet_indicator); //set only wallet transactions e.g. APPLE PAY
			//mcpCavvPreauth.SetCmId("8nAK8712sGaAkls56"); //set only for usage with Offlinx - Unique max 50 alphanumeric characters transaction id generated by merchant
			mcpCavvPreauth.SetCofInfo(cof);

            //MCP Fields
			mcpCavvPreauth.SetMCPVersion("1.0");
			mcpCavvPreauth.SetCardholderAmount("500");
			mcpCavvPreauth.SetCardholderCurrencyCode("840");
			mcpCavvPreauth.SetMCPRateToken("P1538681661706745");
